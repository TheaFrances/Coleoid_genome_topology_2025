...
The interaction frequency threshold for interacting gene pairs was determined by examining scatterplots generated by the R scripts [`get_interaction_threshold_logged_eupsc_sepof.R`](get_interaction_threshold_logged_eupsc_sepof.R). This example is plots *E. scolopes* vs. *S. officinalis* interacting frequency, but a similar method was used for comparing *E. scolopes* and *O. bimaculoides*. Dots are coloured by genomic distance.
