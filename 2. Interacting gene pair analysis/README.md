...
The interaction frequency threshold for interacting gene pairs was determined by examining scatterplots generated by the R scripts. The script [`get_interaction_threshold_logged_eupsc_sepof.R`](get_interaction_threshold_logged_eupsc_sepof.R) plots *E. scolopes* vs. *S. officinalis* interaction frequency, but similar code was used for comparing *E. scolopes* and *O. bimaculoides*. Dots are coloured by genomic distance.
