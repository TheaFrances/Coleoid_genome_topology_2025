...
## Plot boxplots of genomic distances between gene pairs

Plot boxplots of genomic distances between gene pairs across interaction categories, coloured by ***P. maximus*** chromosomal origin using the R script [`ave_10_threshold_eupsc_pec_chr_status_boxplots.R`](ave_10_threshold_eupsc_pec_chr_status_boxplots.R)
