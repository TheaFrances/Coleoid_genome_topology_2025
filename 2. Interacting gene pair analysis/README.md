...
```
## Plot genomic distance vs. genomic distance to define the interaction frequency threshold

Interaction frequency thresholds were determined by examining scatterplots generated by the R scripts [`get_interaction_threshold_logged_eupsc_sepof.R`](get_interaction_threshold_logged_eupsc_sepof.R). This example is comparing *E. scolopes* and *S. officinalis*, but a similar method was used for comparing *E. scolopes* and *O. bimaculoides*.
