...
This section describes how to generate and analyze chromosomal braiding maps based on macrosynteny alignments and sliding window genome comparisons.

### Requirements

* MATLAB version 2025a or newer
* Braidlab toolbox: [https://github.com/jeanluct/braidlab](https://github.com/jeanluct/braidlab)
...
* Load and run the analysis script in MATLAB, adjusting the file name to match the correct comparison and window size.
...
This workflow enables the quantification of topological braiding patterns between aligned chromosomal regions, providing insights into the spatial organization and conservation of 3D genome architecture.
